...
minimize_squared_error <- function(S,
  ...
  res <- Rsolnp::csolnp(pars = pars, fn = fun, lower = LB, upper = UB, eq_fn = eqfun, eq_b = eqB, control = control, ...)

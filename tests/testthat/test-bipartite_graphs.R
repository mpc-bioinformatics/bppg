test_that("test direct_bipartite_graph", {
  ...
  directed_graph <- direct_bipartite_graph(bipartite_graph, from_type = FALSE)
  ...
  directed_graph <- direct_bipartite_graph(bipartite_graph, from_type = TRUE)
